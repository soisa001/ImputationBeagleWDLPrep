...
workflow VcfdistEvaluation {
    input {
        ...
        Int vcfdist_mem_gb = 40              # vcfdist RAM per shard; 16 OOMs on the dense popped rep
...
task Vcfdist {
    input {
        ...
        Int verbosity = 1
        Int cpu = 1
        Int mem_gb = 40              # 16 OOM-killed during wavefront clustering on the dense popped rep;
